...
#Defining a background color for the Canvas 
        self.background = Canvas(self.root,bg='yellow',bd=5,relief=GROOVE,height=470,width=340)
        self.background.place(x=80,y=40)
        self.background = Canvas(self.root,bg='white',bd=5,relief=GROOVE,height=470,width=340)
        self.background.place(x=450,y=40)
